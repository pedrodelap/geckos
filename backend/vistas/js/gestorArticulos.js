    ...
    if (Number(imagenSize) < 2000000 && imagenType == "image/jpeg" || imagenType == "image/png") {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $("#arrastreImagenArticulo").before('<img src="vistas/assets/images/status.gif" id="status">');
            ...
            success: function(respuesta) {
                ...
                if (respuesta == 0) {
                    ...
                    $("#arrastreImagenArticulo").html('<div id="imagenArticulo"><img src="' + respuesta + '" class="img-thumbnail"></div>');
            ...
            if (Number(imagenSize) < 2000000 && imagenType == "image/jpeg" || imagenType == "image/png") {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $("#nuevaFoto").html('<img src="vistas/assets/images/status.gif" style="width:15%" id="status2">');
                    ...
                    success: function(respuesta) {
                        ...
                        if (respuesta == 0) {
                            ...
                            $("#nuevaFoto").html('<img src="' + respuesta + '" class="img-thumbnail">');
...
$("#ordenarArticulos").click(function() {
    ...
    $(".bloqueArticulo h1").css({ "font-size": "14px", "position": "absolute", "padding": "10px", "top": "+3px" })
    $(".bloqueArticulo").css({ "padding": "2px" })
    $("#editarArticulo span").html('<i class="lnr-move" style="padding:8px"></i>')
