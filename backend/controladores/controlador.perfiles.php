		...
		foreach($respuesta as $row => $item){
			...
			echo ' <tr>
					...
					<td>
						...
						<a href="index.php?ruta=perfil&idBorrarUsuario='.$item["id_usuario"].'&borrarImg='.$item["v_foto"].'"><span class="btn btn-danger fa fa-times"></span></a>
					</td>
			      </tr>
							  ...
							  <form style="padding:20px" method="post" enctype="multipart/form-data">
								<div class="modal-body">
										...
										<div class="form-group">
											...
											<input name="editarUsuario" type="text" class="form-control" value="'.$item["v_usuario"].'" required>

										</div>

										<div class="form-group">
										
											<input name="editarNombre" type="text" class="form-control" value="'.$item["v_nombre"].'" required>
										...
										<div class="form-group">
											...
											<input name="editarEmail" type="email" value="'.$item["v_email"].'" class="form-control" required>
										...
										<div class="form-group text-center">
											...
											<img src="'.$item["v_foto"].'" width="10%" class="rounded-circle">

											<input type="hidden" value="'.$item["v_foto"].'" name="editarFoto">
